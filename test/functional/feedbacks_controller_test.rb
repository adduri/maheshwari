...
class FeedbacksControllerTest < ActionController::TestCase
  ...
  test "should create feedback" do
    assert_difference('Feedback.count') do
      post :create, feedback: { details: @feedback.details, user_id: @feedback.user_id }
    end
  ...
  test "should update feedback" do
    put :update, id: @feedback, feedback: { details: @feedback.details, user_id: @feedback.user_id }
    assert_redirected_to feedback_path(assigns(:feedback))
  end
